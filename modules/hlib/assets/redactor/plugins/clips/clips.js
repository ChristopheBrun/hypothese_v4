// todo_cbn Voir comment intégrer plus proprement les modifications faites ici et dans clips.css : AssetsManager, LESS, etc ?
    ...
    return {
        init: function () {
            var items = [
                ...
                ['Blue label', '<span class="label-blue">Label</span>'],
                ['Floating image container - left', '<span class="floating-image-container">***IMAGE ICI***</span>']
            ];
