...
class hArray extends ArrayHelper
{
    ...
    /**
     * Transforme un tableau associatif en un tableau à deux dimensions : le couple clé => valeur du
     * tableau entrant devient une paire (clé, valeur) dans le tableau en sortie.
     * Sert surtout pour les séries de HighCharts
     * @param array $associativeArray
     * @return array
     */
    public static function keyValues2Pair(array $associativeArray)
    {
        $out = array();
